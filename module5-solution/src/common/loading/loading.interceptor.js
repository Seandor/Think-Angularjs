 ...
 * a progress event is emitted to allow listeners to determine when
 * a request has been initiated. When the response completes or a
 * response error occurs, we assume the request has ended and emitted
 * finish event.
 */
